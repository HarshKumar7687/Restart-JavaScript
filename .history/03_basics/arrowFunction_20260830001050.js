...
function newFunction() {
    let username = "John";
    console.log(this.username); // Output: undefined inside function this is not used
}
...
console.log(add(17, 3)); // Output: 20


//implicit return
const multiply = (a, b) => a * b;
console.log(multiply(17, 3)); // Output: 51